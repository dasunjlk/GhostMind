...
- **Llama 3.1 70B** (via Groq) with ultra-fast streaming replies and markdown-like rendering
...
- **Groq API key** in `.env` as `GROQ_API_KEY` (free at https://console.groq.com)
...
- **Invalid / missing API key**  
  Check `.env` and use **Test** in settings. Get a free key at https://console.groq.com. The model used is `llama-3.1-70b-versatile`.
